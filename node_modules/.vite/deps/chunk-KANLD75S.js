...
function __asyncDelegator2(o4) {
  ...
  function verb(n4, f3) {
    i3[n4] = o4[n4] ? function(v2) {
      return (p2 = !p2) ? { value: __await2(o4[n4](v2)), done: n4 === "return" } : f3 ? f3(v2) : v2;
    } : f3;
  }
}
...
var import_dist142, import_dist143, import_dist144, extendStatics2, __assign2;
...
var _2 = class {
  ...
  async setItem(t, e2) {
    await this.indexedDb.setItem(t, safeJsonStringify3(e2));
  }
  async removeItem(t) {
...
function k2(i3) {
  var t;
  return [i3[0], safeJsonParse2((t = i3[1]) != null ? t : "")];
}
var K = class {
  constructor() {
  ...
  async getItem(t) {
    ...
    if (e2 !== null) return safeJsonParse2(e2);
  }
  async setItem(t, e2) {
    this.localStorage.setItem(t, safeJsonStringify3(e2));
  }
  async removeItem(t) {
...
var JSONStringify4 = (data) => JSON.stringify(data, (_3, value) => typeof value === "bigint" ? value.toString() + "n" : value);
var JSONParse3 = (json) => {
  const numbersBiggerThanMaxInt = /([\[:])?(\d{17,}|(?:[9](?:[1-9]07199254740991|0[1-9]7199254740991|00[8-9]199254740991|007[2-9]99254740991|007199[3-9]54740991|0071992[6-9]4740991|00719925[5-9]740991|007199254[8-9]40991|0071992547[5-9]0991|00719925474[1-9]991|00719925474099[2-9])))([,\}\]])/g;
  const serializedData = json.replace(numbersBiggerThanMaxInt, '$1"$2n"$3');
  return JSON.parse(serializedData, (_3, value) => {
...
var f2 = class {
  ...
  async send(e2) {
    ...
    try {
      this.socket.send(safeJsonStringify4(e2));
    } catch (t) {
  ...
  onPayload(e2) {
    ...
    const t = typeof e2.data == "string" ? safeJsonParse3(e2.data) : e2.data;
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-KANLD75S.js.map
