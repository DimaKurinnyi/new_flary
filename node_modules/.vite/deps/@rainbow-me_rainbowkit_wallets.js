...
import {
  ...
  safe,
  walletConnect
} from "./chunk-PKCQU72B.js";
import "./chunk-W27R6ALG.js";
import "./chunk-5DHYTN6G.js";
import {
  createConnector,
  injected
} from "./chunk-GWXI3H37.js";
import "./chunk-3UTW6DC5.js";
import "./chunk-NPU3YFN2.js";
import "./chunk-T7OT6S6N.js";
import "./chunk-PJDWXBDF.js";
import "./chunk-LPOXMLCL.js";
...
var tahoWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./tahoWallet-L6KHUNKD-MGQK2JIR.js")).default,
    downloadUrls: {
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-FNSU4KNU-7XQLUPJW.js")).default,
...
var valoraWallet = ({
  ...
  id: "valora",
  name: "Valora",
  iconUrl: async () => (await import("./valoraWallet-RX3ONO47-WBYB5QRB.js")).default,
...
var xdefiWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./xdefiWallet-ZA65GDWS-S3GYZJDE.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var zealWallet = ({
  ...
  return {
    ...
    name: "Zeal",
    rdns: "app.zeal",
    iconUrl: async () => (await import("./zealWallet-URNQ2AWF-IBDELMPP.js")).default,
    iconBackground: "#fff0",
    iconAccent: "#00FFFF",
    downloadUrls: {
...
var zerionWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./zerionWallet-CYFHB5PA-CIV2HILX.js")).default,
    iconAccent: "#2962ef",
...
var safepalWallet = ({
  ...
  return {
    id: "safepal",
    name: "SafePal Wallet",
    iconUrl: async () => (await import("./safepalWallet-KQJ4OCNH-GD6F76HD.js")).default,
...
function seifWallet() {
  ...
  return {
    ...
    iconUrl: async () => (await import("./seifWallet-QATOS33A-5LD2GNBM.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var talismanWallet = () => ({
  ...
  name: "Talisman",
  rdns: "xyz.talisman",
  iconUrl: async () => (await import("./talismanWallet-BLXUHONV-JAZFECAK.js")).default,
  iconBackground: "#fff",
...
var tokenPocketWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./tokenPocketWallet-BVMBOYTC-ZN7UUVXF.js")).default,
...
var tokenaryWallet = () => ({
  id: "tokenary",
  name: "Tokenary",
  iconUrl: async () => (await import("./tokenaryWallet-Z2IGVXSA-GSQVEVPR.js")).default,
  iconBackground: "#ffffff",
...
var trustWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./trustWallet-E2GVGE4U-DOUT7PLO.js")).default,
    // Note that we never resolve `installed` to `false` because the
...
var subWallet = ({
  ...
  return {
    ...
    name: "SubWallet",
    rdns: "app.subwallet",
    iconUrl: async () => (await import("./subWallet-LOZELSAO-BBN62YWW.js")).default,
    iconBackground: "#fff",
...
var uniswapWallet = ({
  ...
  id: "uniswap",
  name: "Uniswap Wallet",
  iconUrl: async () => (await import("./uniswapWallet-T26M44R7-U2JPLCCH.js")).default,
...
var paraSwapWallet = ({
  ...
  iconUrl: async () => (await import("./paraSwapWallet-TMV5MUEF-6TPABSZ7.js")).default,
...
var phantomWallet = () => {
  return {
    ...
    name: "Phantom",
    rdns: "app.phantom",
    iconUrl: async () => (await import("./phantomWallet-IPGVKCAB-HLGFQ7BP.js")).default,
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-2SR6TVBF-23A6PRAT.js")).default,
...
var rabbyWallet = () => ({
  id: "rabby",
  name: "Rabby Wallet",
  iconUrl: async () => (await import("./rabbyWallet-FLVUU35F-ICWMR4FA.js")).default,
  rdns: "io.rabby",
...
var ramperWallet = () => {
  ...
  return {
    id: "ramper",
    name: "Ramper Wallet",
    iconUrl: async () => (await import("./ramperWallet-AF5AKK2S-5NAVZ5J3.js")).default,
...
var roninWallet = ({
  ...
  return {
    id: "ronin",
    name: "Ronin Wallet",
    iconUrl: async () => (await import("./roninWallet-SAB5ESVK-HY5A5SF3.js")).default,
    iconBackground: "#ffffff",
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-VUYZPLY4-VFKVMPTL.js")).default,
  installed: (
...
var safeheronWallet = () => ({
  ...
  iconUrl: async () => (await import("./safeheronWallet-6JG77AKC-PKXCEDRZ.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-YFHEHW7V-M75J7M7Z.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var mewWallet = () => {
  return {
    id: "mew",
    name: "MEW wallet",
    iconUrl: async () => (await import("./mewWallet-6V4UZOQC-OZUOYR6B.js")).default,
    iconBackground: "#fff",
...
var nestWallet = () => ({
  ...
  name: "Nest",
  rdns: "xyz.nestwallet",
  iconUrl: async () => (await import("./nestWallet-BFZZZYLV-AMCZBR2E.js")).default,
  iconBackground: "#fff0",
...
var oneInchWallet = ({
  ...
  id: "1inch",
  name: "1inch Wallet",
  iconUrl: async () => (await import("./oneInchWallet-D7BQOLOO-JV43GUHV.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var okxWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./okxWallet-GJMKZIND-KL66VSEQ.js")).default,
    iconAccent: "#000",
    iconBackground: "#000",
    downloadUrls: {
...
var omniWallet = ({
  ...
  id: "omni",
  name: "Omni",
  iconUrl: async () => (await import("./omniWallet-DEYUMT4A-DXA6EGA4.js")).default,
  iconBackground: "#000",
  downloadUrls: {
...
var oktoWallet = ({
  ...
  id: "Okto",
  name: "Okto",
  iconUrl: async () => (await import("./oktoWallet-GJFOPPEA-AJJGSJFT.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var oneKeyWallet = () => {
  return {
    ...
    iconAccent: "#00B812",
    iconBackground: "#fff",
    iconUrl: async () => (await import("./oneKeyWallet-4MM7G2SZ-HAAFL26Q.js")).default,
...
var frontierWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./frontierWallet-HNIG7QYQ-EKRSSERO.js")).default,
...
var iopayWallet = ({
  ...
  id: "iopay",
  name: "ioPay Wallet",
  iconUrl: async () => (await import("./iopayWallet-IJHJ7NYT-JOSYM7UL.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var kaiaWallet = ({
  ...
  return {
    id: "kaia",
    name: "Kaia Wallet",
    iconUrl: async () => (await import("./kaiaWallet-5K6WZ3AH-YTSH3MBI.js")).default,
...
var krakenWallet = ({
  ...
  id: "kraken",
  name: "Kraken Wallet",
  iconUrl: async () => (await import("./krakenWallet-DAOXUKWO-FVBCK25A.js")).default,
  iconBackground: "#FFD8EA",
  downloadUrls: {
...
var ledgerWallet = ({
  ...
  iconAccent: "#000",
  name: "Ledger",
  iconUrl: async () => (await import("./ledgerWallet-KZKJ5Q2S-2LDHXYCA.js")).default,
  downloadUrls: {
...
var kaikasWallet = ({
  ...
  return {
    id: "kaikas",
    name: "Kaikas Wallet",
    iconUrl: async () => (await import("./kaikasWallet-F6Z6IPWN-GM344HO2.js")).default,
...
var kresusWallet = ({
  ...
  id: "kresus-wallet",
  name: "Kresus Wallet",
  iconUrl: async () => (await import("./kresusWallet-AUJWLAOF-GBWG5PTI.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var magicEdenWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./magicEden-PKT2ZXEQ-KZQ3ZCWX.js")).default,
...
var desigWallet = () => {
  return {
    id: "desig",
    name: "Desig Wallet",
    iconUrl: async () => (await import("./desigWallet-WJMSF3PS-T7PVLPYR.js")).default,
    iconBackground: "#ffffff",
...
var enkryptWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./enkryptWallet-FR4QCDFK-3IJKEZHH.js")).default,
    iconBackground: "#FFFFFF",
    downloadUrls: {
...
var foxWallet = ({
  ...
  return {
    id: "foxwallet",
    name: "FoxWallet",
    iconUrl: async () => (await import("./foxWallet-5ESSNXJV-43VCAZ3K.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var dawnWallet = () => ({
  id: "dawn",
  name: "Dawn",
  iconUrl: async () => (await import("./dawnWallet-ONVAA3S4-ZH73HBVZ.js")).default,
...
var gateWallet = ({
  ...
  return {
    ...
    name: "Gate Wallet",
    rdns: "io.gate.wallet",
    iconUrl: async () => (await import("./gateWallet-ZVEZILRP-UHDFIPQK.js")).default,
    iconAccent: "#fff",
    iconBackground: "#fff",
    downloadUrls: {
...
var imTokenWallet = ({
  ...
  id: "imToken",
  name: "imToken",
  iconUrl: async () => (await import("./imTokenWallet-N2MYFADO-BNLKLFON.js")).default,
...
var frameWallet = () => ({
  ...
  iconUrl: async () => (await import("./frameWallet-FDBUY4AA-EZ2ZEL2C.js")).default,
...
var injectedWallet = () => ({
  id: "injected",
  name: "Browser Wallet",
  iconUrl: async () => (await import("./injectedWallet-H7LYKTQS-4QTPZW5Y.js")).default,
  iconBackground: "#fff",
  createConnector: getInjectedConnector({})
});
...
var braveWallet = () => ({
  ...
  iconUrl: async () => (await import("./braveWallet-6QAF4GDN-NECSLHCP.js")).default,
  iconBackground: "#fff",
...
var clvWallet = ({
  ...
  return {
    id: "clv",
    name: "CLV",
    iconUrl: async () => (await import("./clvWallet-ZIMSRU5J-NWWMVZM3.js")).default,
    iconBackground: "#fff",
    iconAccent: "#BDFDE2",
...
var coin98Wallet = ({
  ...
  return {
    id: "coin98",
    name: "Coin98 Wallet",
    iconUrl: async () => (await import("./coin98Wallet-RFXRNVWP-YZITMSAS.js")).default,
...
var bloomWallet = ({
  ...
  iconBackground: "#000",
  iconAccent: "#000",
  iconUrl: async () => (await import("./bloomWallet-MXLAOWS6-QWZNGAPF.js")).default,
  downloadUrls: {
...
var bybitWallet = ({
  ...
  return {
    ...
    name: "Bybit Wallet",
    rdns: "com.bybit",
    iconUrl: async () => (await import("./bybitWallet-GR4PFINZ-QC7IWDY7.js")).default,
...
var compassWallet = () => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./compassWallet-3LBTWCKI-5TZJP6BE.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var coinbaseWallet2 = ({ appName, appIcon }) => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./coinbaseWallet-WWX6LF36-FEKVXZQD.js")).default,
    iconAccent: "#2c5ff6",
...
var coreWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./coreWallet-52SXITOT-Z6VPF7WM.js")).default,
...
var argentWallet = ({
  ...
  id: "argent",
  name: "Argent",
  iconUrl: async () => (await import("./argentWallet-M6SBG4CU-XV7F765Y.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var bestWallet = ({
  ...
  id: "bestWallet",
  name: "Best Wallet",
  iconUrl: async () => (await import("./bestWallet-XRIABRUE-2FFI4SII.js")).default,
...
var bitskiWallet = () => ({
  ...
  iconUrl: async () => (await import("./bitskiWallet-X5NWL5CE-5ULYKIO7.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var binanceWallet = ({
  ...
  id: "binance",
  name: "Binance Wallet",
  iconUrl: async () => (await import("./binanceWallet-BCWLBY3Q-TRBDKNMF.js")).default,
  iconBackground: "#000000",
  downloadUrls: {
...
var bifrostWallet = ({
  ...
  return {
    id: "bifrostWallet",
    name: "Bifrost Wallet",
    iconUrl: async () => (await import("./bifrostWallet-ORF3DABG-G2WESL2Z.js")).default,
    iconBackground: "#fff",
...
var bitverseWallet = ({
  ...
  iconUrl: async () => (await import("./bitverseWallet-6SGDFATJ-3D7C6UU4.js")).default,
...
var bitgetWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./bitgetWallet-CLYTW54T-ECXWX36D.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
